<?php
/*
Plugin Name: WP-OGP SHNR customed
...
define('WPOGP_SHNR_CUS_DOMAIN', "wp-ogp-shnr-customed");

load_plugin_textdomain(WPOGP_SHNR_CUS_DOMAIN, '', dirname( plugin_basename( __FILE__ ) ) . '/lang');
...
$ogpt_fields = array(
	'fb:admins' => array(
		'note' => __('A comma-separated list of Facebook user IDs that administers this site. You can find your user id by visiting <a href="http://apps.facebook.com/what-is-my-user-id/" target="_blank">http://apps.facebook.com/what-is-my-user-id/</a>', WPOGP_SHNR_CUS_DOMAIN),
		'style' => 'width: 200px'
	),
	'fb:app_id' => array(
		'note' => __('A Facebook Platform application ID that administers this site.', WPOGP_SHNR_CUS_DOMAIN),
		'style' => 'width: 200px'
	)
);
...
$ogpt_configs = array(
	'custom_field_key' => array(
		'label' => __('Custom field key', WPOGP_SHNR_CUS_DOMAIN),
		'note' => __('The custom field key that is used by og:description.', WPOGP_SHNR_CUS_DOMAIN),
		'style' => 'width: 200px',
		'default' => 'description'
	),
	'using_post_excerpt' => array(
		'label' => __('Using post excerpt', WPOGP_SHNR_CUS_DOMAIN),
		'type' => 'checkbox',
		'options' => 1,
		'note' => __('The og:description is used by the post excerpt.', WPOGP_SHNR_CUS_DOMAIN),
		'default' => 0
	),
	'extraction_type' => array(
		'label' => __('Text extraction type', WPOGP_SHNR_CUS_DOMAIN),
		'options' => array('word' => __('Word Count', WPOGP_SHNR_CUS_DOMAIN), 'character' => __('Character Count', WPOGP_SHNR_CUS_DOMAIN)),
		'separator' => "<br />",
		'type' => 'radio',
		'default' => 'word'
	),
	'desc_size' => array(
		'label' => __('og:description max size', WPOGP_SHNR_CUS_DOMAIN),
		'note' => __('The max word count or character length of the og:description.', WPOGP_SHNR_CUS_DOMAIN),
		'style' => 'width: 100px',
		'default' => 75
	),
	'thumbnail_type' => array(
		'label' => __('Using og:image type', WPOGP_SHNR_CUS_DOMAIN),
		'default' => 'single',
		'type' => 'radio',
		'separator' => '<br />',
		'options' => array('single' => __('Post thumbnail', WPOGP_SHNR_CUS_DOMAIN), 'multiple' => __('Images used in post content', WPOGP_SHNR_CUS_DOMAIN))
	),
	'thumbnail_amount' => array(
		'label' => __('Max og:image amount', WPOGP_SHNR_CUS_DOMAIN),
		'default' => 1,
		'note' => __('The max og:image amount when the using og:image type is checked by "Images used in post content". If "0" is set, og:image is used from all.', WPOGP_SHNR_CUS_DOMAIN)
	),
	'force_using_default_image' => array(
		'label' => __('Force using default image', WPOGP_SHNR_CUS_DOMAIN),
		'default' => 0,
		'options' => 1,
		'type' => 'checkbox',
		'note' => __('The default image is anytime used when og:image type is "Images used in post content".', WPOGP_SHNR_CUS_DOMAIN)
	),
	'default_image' => array(
		'label' => __('Default image URL', WPOGP_SHNR_CUS_DOMAIN),
		'style' => 'width: 98%'
	),
	'auto_include' => array(
		'label' => __('Include automatically og tags', WPOGP_SHNR_CUS_DOMAIN),
		'type' => 'checkbox',
		'options' => 1,
		'default' => 1,
	)
...
function wpogp_set_data() {
	...
	elseif (is_single() || is_page()):
		...
		// add 131202
		global $post;
		$my_ogp_img = get_post_meta( $post->ID, 'my_ogp', true );
		if($my_ogp_img != ""){
			$data['og:image'] = $my_ogp_img;
		}else{
...
// add 131202
/* include PM uploader custom field */
include_once dirname(__FILE__) . '/libs/class-customs.php';
